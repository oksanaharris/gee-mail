...
// Made these variables global so I could reference them in the new function to generate a new message
...
(function (){
  ...
  //test if this code has loaded or run
  console.log('just loaded geemails');
